 ...
 * Spring-Boot JAR包加密器
 *
 * @author Payne 646742615@qq.com 2018/11/22 15:27
 */
public class XBootEncryptor extends XEntryEncryptor<JarArchiveEntry> implements XEncryptor,
    XConstants {
    ...
    try {
      ...
      if (!indexes.isEmpty()) {
        ...
        JarArchiveEntry xjarInfIdx = new JarArchiveEntry(
            BOOT_INF_CLASSES + XJAR_INF_DIR + XJAR_INF_IDX);
      ...
      String mainClass =
          manifest != null && manifest.getMainAttributes() != null ? manifest.getMainAttributes()
              .getValue("Main-Class") : null;
      if (mainClass != null) {
