 ...
 * X类加载器
 *
 * @author Payne 646742615@qq.com 2018/11/23 23:04
 */
public class XBootClassLoader extends LaunchedClassLoader {
  ...
  public XBootClassLoader(URL[] urls, ClassLoader parent, XDecryptor xDecryptor,
      XEncryptor xEncryptor, XKey xKey) throws Exception {
    ...
    this.getResource = XReflection.method(urlClassPath.getClass(), "getResource", String.class)
        .method();
    this.getCodeSourceURL = XReflection.method(getResource.getReturnType(), "getCodeSourceURL")
        .method();
    this.getCodeSigners = XReflection.method(getResource.getReturnType(), "getCodeSigners")
        .method();
  }
